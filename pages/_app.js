...
function Loading({children}) {
  ...
  useEffect(() => {
    // Set loading to true if requested page didn't load yet
    const start = url => url !== router.asPath && setLoading(true)
    // Set loading to false if requested page is loaded
  ...
  return loading && (
    <div className="w-full mx-auto my-16 flex items-center justify-center" role="status">
